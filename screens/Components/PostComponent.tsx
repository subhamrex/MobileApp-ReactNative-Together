    ...
    render() {
        return (
            <View style={{marginBottom:10}}> 
                <View style={{width:screenWidth, height:50, backgroundColor: "#f5f5dc", flexDirection:'row', justifyContent:'space-between', alignItems:'center', borderBottomColor:'grey', borderBottomWidth:0.07}}>
                    <TouchableOpacity 
                ...
                <View>
                    ...
                    >
                        {
                        this.props.item.photos?.map((e:any)=>
                        ...
                        onPress={()=>this.likePost()}>
                            {
                                ...
                                <Image source={require('../../assets/images/like-red2.png')} style={{width:25,height:25, margin:10}} />
                                :
                                    (this.state.liked == true)?
                                    <Image source={require('../../assets/images/like-red2.png')} style={{width:25,height:25, margin:10}} />
                                    :
                                    <Image source={require('../../assets/images/like2.png')} style={{width:25,height:25, margin:10}} />
                            }
                        </TouchableOpacity>
                        <Image source={require('../../assets/images/comment2.png')} style={{width:25,height:25, margin:10}} />
                        <Image source={require('../../assets/images/share2.png')} style={{width:25,height:25, margin:10}} />
                    </View>
                    <TouchableOpacity
                    onPress={()=>this.savePost()}>
                        {
                            (this.props.item.savedBy.includes(this.props.user.uid) && this.state.saved == undefined)?
                            <Image source={require('../../assets/images/save-black2.png')} style={{width:25,height:25, margin:10}} />
                            :
                                (this.state.saved == true)?
                                <Image source={require('../../assets/images/save-black2.png')} style={{width:25,height:25, margin:10}} />
                                :
                                <Image source={require('../../assets/images/save2.png')} style={{width:25,height:25, margin:10}} />
                ...
                <View style={{justifyContent:'space-between',alignItems:'center', flexDirection:'row'}}>
                    ...
                    <Image source={require('../../assets/images/emojis2.png')} style={{width:80, height:17, margin:10}}/>
                </View>
